...
The software was implemented by expanding and modifying the code structure of the git hub repository https://github.com/unitreerobotics/unitree_mujoco, focusing on the G1 EDU model. 